namespace WebApplication1.Migrations
{
    ...
    public partial class WebApplication1ModelsApplicationDbContext : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.SaasEcomUsers", t => t.SaasEcomUserId)
                .Index(t => t.SaasEcomUserId);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.SaasEcomUsers", t => t.Customer_Id)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.SaasEcomUsers", t => t.SaasEcomUser_Id)
                .Index(t => t.SaasEcomUser_Id);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.SaasEcomUsers", t => t.UserId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.SaasEcomUsers", t => t.Id)
                .Index(t => t.Id);
        ...
        {
            DropForeignKey("dbo.AspNetUsers", "Id", "dbo.SaasEcomUsers");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropForeignKey("dbo.LineItems", "Invoice_Id", "dbo.Invoices");
            DropForeignKey("dbo.Subscriptions", "UserId", "dbo.SaasEcomUsers");
            ...
            DropForeignKey("dbo.AspNetUserRoles", "SaasEcomUser_Id", "dbo.SaasEcomUsers");
            DropForeignKey("dbo.AspNetUserLogins", "SaasEcomUser_Id", "dbo.SaasEcomUsers");
            DropForeignKey("dbo.Invoices", "Customer_Id", "dbo.SaasEcomUsers");
            DropForeignKey("dbo.CreditCards", "SaasEcomUserId", "dbo.SaasEcomUsers");
            DropForeignKey("dbo.AspNetUserClaims", "SaasEcomUser_Id", "dbo.SaasEcomUsers");
            ...
            DropIndex("dbo.AspNetUserRoles", new[] { "SaasEcomUser_Id" });
            DropIndex("dbo.AspNetUserRoles", new[] { "RoleId" });
            DropIndex("dbo.AspNetUserLogins", new[] { "SaasEcomUser_Id" });
            DropIndex("dbo.AspNetUserClaims", new[] { "SaasEcomUser_Id" });
            DropIndex("dbo.SaasEcomUsers", "UserNameIndex");
            ...
            DropIndex("dbo.CreditCards", new[] { "SaasEcomUserId" });
